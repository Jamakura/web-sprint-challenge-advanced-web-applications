...
Tokens are piece of data that can only be read by a specific server to identify a particular user, such as login authorization.

2. What steps can you take in your web apps to keep your data secure?

To keep the data safe in our websites we can makes sure the private data is kept behind proteted routes that require authorization to access.

3. Describe how web servers work.

Web servers work by getting a request from a user for the dns or ip address of a website, they process the request and sent the information back to displacy the web site requested.

4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

You can use Post, Get, Put and Delete as the HTTP methods for working with Api/servers.
